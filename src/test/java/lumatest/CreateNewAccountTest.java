...
//    String lastName = fakeData.name().lastName();
    ...
    String name = connectdb.getTableColumnData("select* from user","firstname").get(0);
    String lastName = connectdb.getTableColumnData("select* from user","lastname").get(0);
    String emailAddress = connectdb.getTableColumnData("select* from user","email").get(0);
    ...
    public void RegisterWithAnExistingCredentials() throws InterruptedException {
        ...
        createnewAccountPageMagento.typeEmailAddress("gsbappy1@gmail.com");
    ...
    public void InvalidCredentials() {
        ...
        createnewAccountPageMagento.typeEmailAddress("gsbappy1@gmail.");
       // String password  = ConnectDB.getTableColumnData("select * from cred","password").get(0);
        createnewAccountPageMagento.typePassword("password&1234");
        createnewAccountPageMagento.typeConfirmPassword("password&1234");
        createnewAccountPageMagento.clickOnCreateanAccountButton();
    ...
    public void RegisterNewAcount() throws InterruptedException {
        ...
        createnewAccountPageMagento.typeFirstName(name);
        createnewAccountPageMagento.typeLastName(lastName);
        createnewAccountPageMagento.typeEmailAddress("gsbappy1@yahoo.com");
        createnewAccountPageMagento.typePassword("password&1234");
        createnewAccountPageMagento.typeConfirmPassword("password&1234");
        createnewAccountPageMagento.clickOnCreateanAccountButton();

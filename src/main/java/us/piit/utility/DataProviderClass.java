...
//    }
    ...
    public Object[][] excelDPOussamaReviewTest() throws IOException {
        String path = ExcelReader.currentDir + File.separator + "data" + File.separator + "reviewtestingoussama.xlsx";
        ExcelReader excelReader = new ExcelReader(path);
    ...
    @DataProvider
    public Object[][] excelDPLumaSigninTest() throws IOException {
        String path = ExcelReader.currentDir + File.separator + "data" + File.separator + "lumasignindata.xlsx";
        ExcelReader excelReader = new ExcelReader(path);
        Object[][] arrObj = excelReader.getExcelData(path,"Sheet1");
        return arrObj;
    }

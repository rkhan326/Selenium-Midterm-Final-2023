...
public class SignupPage extends CommonAPI {
    ...
    @FindBy(css = "#password") WebElement signupPasswordField;
    @FindBy(css = "#first_name") WebElement signupFNameField;
    @FindBy(css = "#last_name") WebElement signupLNameField;
    @FindBy(css = "#address1") WebElement signupAddressField;
    @FindBy(css = "#state") WebElement signupStateField;
    @FindBy(css = "#city") WebElement signupCityField;
    @FindBy(css = "#zipcode") WebElement signupZipcodeField;
    @FindBy(css = "#mobile_number") WebElement signupMobileField;
    @FindBy(css = ".btn.btn-default") WebElement createAccountButton;
    @FindBy(css = ".btn.btn-primary") WebElement signupContinueButton;
    ...
    public void clickClickOnSingupContinueButton() {
